...
function Member({ img, name, username, role, last }) {
	...
	const isRolePickerOpen = openRolePicker;
	...
	return (
		...
		>
			...
			<StyledView className='absolute right-0'>
				{isRolePickerOpen ? (
					<StyledAnimatedView style={roleSelectorStyle} className='flex-row bg-grey border-outline border-2 rounded-3xl mr-[8px] py-1 gap-x-2'>					
